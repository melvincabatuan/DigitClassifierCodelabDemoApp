# Digit Classifier Codelab DemoApp

## Objectives
- Train a handwritten digit classification model using TensorFlow.
- Convert a trained TensorFlow model into the TensorFlow Lite format.
